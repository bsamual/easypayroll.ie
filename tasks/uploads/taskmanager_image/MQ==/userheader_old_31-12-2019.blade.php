...
<?php
 ...
 elseif($page_segment == "rctclients") { $title = 'GBS & Co RCT Tracker'; }
 elseif($page_segment == "expand_rctclient") { $title = 'GBS & Co RCT Tracker'; }
 ...
 elseif($page_segment == "yeadend_liability") { $title = 'Year End Manager'; }
 ...
 elseif($page_segment == "client_request_system") { $title = 'Client Request Manager'; }
 elseif($page_segment == "client_request_manager") { $title = 'Client Request Manager'; }
 elseif($page_segment == "client_request_edit") { $title = 'Client Request Manager'; }
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right menu" style="margin-right: 25.5%;">
            <li class="dropdown <?php if($segment1 == "client_management" || $segment1 == "invoice_management" || $segment1 == "client_statements" || $segment1 == "receipt_management" || $segment1 == "time_management" || $segment1 == "aml_system" || $segment1 == "client_request_system" || $segment1 == "client_request_manager" || $segment1 == "client_request_edit" || $segment1 == "client_request_view") { echo 'active'; } ?>"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Central Functions</a>
