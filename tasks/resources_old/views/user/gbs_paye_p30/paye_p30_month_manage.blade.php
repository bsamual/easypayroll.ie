...
@section('content')
<style>
body{background:url('<?php echo URL::to('assets/images/paye_p30_month.jpg')?>') no-repeat center top !important; 
    ...
    <div class="select_button">
        <table class="table table_bg" style="width:70%">
          ...
          <tbody>
            ...
            ?>
            <tr>
                <td style="text-align:left; border:1px solid #000"><a href="<?php echo URL::to('user/gbs_paye_p30_select_month/'.base64_encode($month->month_id))?>" class="btn" style="text-align:left;"><?php echo $month_name.' '.$year->year_name.' PAYE M.R.S'; ?></a></td>
