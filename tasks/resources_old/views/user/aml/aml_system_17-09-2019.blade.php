                        ...
                        <?php
                            ...
                            if(count($clientlist)){              
                              foreach($clientlist as $key => $client){
                                  ...
                                  if(count($aml_bank)){
                                    ...
                                    <a href="javascript:" class="bank_class" data-toggle="modal" data-target=".bank_modal" ><i class="fa fa-plus faplus add_bank" data-toggle="tooltip" data-original-title="Add Bank" data-element="'.$client->client_id.'" style="margin-left:10px;"></i></a>
                                    ';
                                  }
                                  else{
                                    $bank_output='
                          ...
                          ?>
                            <tr class="edit_task <?php echo $disabled; ?>" style="<?php echo $style; ?>"  id="clientidtr_<?php echo $client->id; ?>">
                                ...
                                <td align="left" id="client_source_<?php echo $client->client_id?>">
                                  <?php echo $client_source?>
                                </td>
                                <td align="left"></td>
                                <td align="left"><a href="javascript:" id="'.base64_encode($client->id).'" class="" style="'.$style.'"></a></td>
<!-- 
                                ...
                                <td style="<?php echo $style; ?>" align="left">
                                  <select class="form-control risk_class" data-element="<?php echo $client->client_id?>" >
                                    <option value="1" <?php echo $risk_select?>>Green</option>
                                    <option value="2" <?php echo $risk_select?>>Yellow</option>
                                    <option value="3" <?php echo $risk_select?>>Red</option>
                                  </select>
