...
<div class="modal fade" id="p30_review_modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      ...
      <form id="review_p30_due_form" action="<?php echo URL::to('user/import_gbs_p30_review_due'); ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="page_title">
    ...
    <div class="col-lg-7 padding_00 button_top_right">
      ...
      <ul style="margin-right: 13%;">
        ...
        <li class="<?php if($check_current_year->year_id == $monthid->year) { echo ''; } else { echo 'disable_button'; }?>"><a href="<?php echo URL::to('user/gbs_p30_close_create_new_month/'.$monthid->year); ?>" id="review_month" class="" style="float:right">Close and Create New Month</a></li>

        <?php $check_current_month = DB::table('p30_month')->orderBy('month_id','desc')->first(); ?>

        <li class="<?php if($check_current_month->month_id == $monthid->month_id) { echo ''; } else { echo 'disable_button'; }?>"><a href="<?php echo URL::to('user/gbs_p30_review_month/'.$monthid->month_id); ?>" id="review_month">Review Month</a></li>
...
<div class="modal fade emailunsent" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="<?php echo URL::to('user/gbs_p30_email_unsent_files'); ?>" method="post" >
              ...
              <tr class="task_tr_std <?php echo $hide_tr; ?> <?php echo $hidena_tr; ?>" id="taskidtr_<?php echo $result->id; ?>">
                  ...
                  <td>
                    ...
                    <input type="text" class="form-control common_input network_input" name="" value="<?php echo $result->network ?>" disabled><br/>
                      ...
                      <div class="img_div">
                        ...
                        <form name="image_form" id="image_form" action="<?php echo URL::to('user/gbs_p30_task_image_upload'); ?>" method="post" enctype="multipart/form-data" style="text-align: left;">
                  ...
                  <td>
                    ...
                    <div class="img_div_automatic">
                        ...
                        <form name="image_automatic_form" id="image_automatic_form" action="<?php echo URL::to('user/gbs_p30_task_automatic_image_upload'); ?>" method="post" enctype="multipart/form-data" style="text-align: left;">
...
$(window).change(function(e) {
...

  {
      ...
      $.ajax({
          ...
          url:"<?php echo URL::to('user/gbs_p30_tasklevel_update'); ?>",
...

  {
      ...
      $.ajax({
          ...
          url:"<?php echo URL::to('user/gbs_p30_period_update'); ?>",
...
$(window).click(function(e) {
...

  {
...

    {
      ...
      $.ajax({
        ...
        url:"<?php echo URL::to('user/update_gbs_p30_incomplete_status_month'); ?>",
...

  {
    ...
    $.ajax({
      ...
      url:"<?php echo URL::to('user/download_gbs_p30_review'); ?>",
...

  {
    ...
    $.ajax({
        ...
        url:"<?php echo URL::to('user/gbs_p30_report_task'); ?>",
...

  {
...

    {
      ...
      $.ajax({
        ...
        url:"<?php echo URL::to('user/download_gbs_p30_pdf_report'); ?>",
...

    {
      ...
      if (r == true) {
          ...
          $.ajax({
              ...
              url:"<?php echo URL::to('user/gbs_p30_task_status_update'); ?>",
      ...
      setTimeout(function() {
...

          {
              ...
              $.ajax({
                ...
                url:'<?php echo URL::to('user/gbs_p30_edit_email_unsent_files'); ?>',
...

  {
    ...
    if (r == true) {
      ...
      $.ajax({
          ...
          url:"<?php echo URL::to('user/gbs_p30_task_delete_image'); ?>",
...

  {
    ...
    if (r == true) {
      ...
      $.ajax({
          ...
          url:"<?php echo URL::to('user/gbs_p30_task_delete_xml'); ?>",
  ...
  setTimeout(function() {
    ...
    var newinput = input.replace(/,/g , "");
      ...
      $.ajax({
        ...
        url:"<?php echo URL::to('user/gbs_p30_task_liability_update'); ?>",
