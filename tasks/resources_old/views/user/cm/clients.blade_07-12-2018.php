      ...
      <div class="modal-content">
        <form id="import_existing_clients_form" action="<?php echo URL::to('user/import_existing_clients'); ?>" method="post" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <input type="file" name="exists_file" id="exists_file" class="form-control input-sm" accept=".csv" required>
  ...
  <div class="page_title">
        <h4 class="col-lg-3" style="padding: 0px;">
            ...
            <?php $check_incomplete = Db::table('user_login')->where('userid',1)->first(); if($check_incomplete->cm_incomplete == 1) { $inc_checked = 'checked'; } else { $inc_checked = ''; } ?>
                <input type="checkbox" name="show_incomplete" id="show_incomplete" value="1" checked style="margin-right:10px"><label for="show_incomplete">Hide Deactivated Accounts</label>
  </div>
          ...
          if($(this).parents("tr").is(":visible"))
          {
            setTimeout(function(){
                $.ajax({
                  ...
                  type:"post",
                  data:{client_id:id,secondary:secondary,content:content,subject:subject},
                  success: function(result) {
