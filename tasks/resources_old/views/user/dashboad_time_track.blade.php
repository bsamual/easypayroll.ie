        ...
        <div class="modal-content">
          ...
          <div class="modal-body"> 
            ...
            <div class="col-md-6 stop_right_body_class">
              ...
              <div class="hide_group_div" style="margin-top:10px;background: #fff;padding:10px;min-height:300px;max-height: 300px;overflow-y: scroll;">
                          ...
                          foreach ($payelist as $keytask => $task) {
                              ...
                              if(count($get_clients))
                              {
                                ...
                                echo '<tr class="client_tr '.$label_cls.'">
                                        <td class="client_td" style="'.$label_color.'"><input type="checkbox" name="client_exclude" class="client_exclude" value="'.$task->id.'"><label>&nbsp;</label></td>
              ...
              <table class="table hide_group_div" style="margin-top:20px;width:40%; ">
                  <tr>
  ...
  if($(e.target).hasClass('select_all_clients'))
  {
    ...
    else
    {
      ...
      if(minutes_per_client < 1)
      {
        ...
        $(".minutes_per_client").html(minutes_per_client);
      }
    }
  }
    ...
    $.ajax({
      ...
      success:function(result){
        ...
        if(bulk_job == "1")
        {
          ...
          $("#stop_job").val('Stop Even Bulk Job');
