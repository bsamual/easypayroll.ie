	...
	*/
          ...
          <div class="company_details_div">
	            ...
	            <div class="account_details_div">
	              <div class="account_details_main_address_div">
	                  <div class="account_details_address_div">                      
            ...
            if($invoice_details->bn_row1 != ''){
            	$row1 = '            	
                  <div class="class_row_td left">'.$invoice_details->f_row1.'</div>
            ...
            if($invoice_details->bo_row2 != ''){
            	$row2 = '            	
                  <div class="class_row_td left">'.$invoice_details->g_row2.'</div>
            ...
            if($invoice_details->bp_row3 != ''){
            	$row3 = '            	
                  <div class="class_row_td left">'.$invoice_details->h_row3.'</div>
            ...
            if($invoice_details->bq_row4 != ''){
            	$row4 = '            	
                  <div class="class_row_td left">'.$invoice_details->i_row4.'</div>
            ...
            if($invoice_details->br_row5 != ''){
            	$row5 = '            	
                  <div class="class_row_td left">'.$invoice_details->j_row5.'</div>
            ...
            if($invoice_details->bs_row6 != ''){
            	$row6 = '            	
                  <div class="class_row_td left">'.$invoice_details->k_row6.'</div>
            ...
            if($invoice_details->bt_row7 != ''){
            	$row7 = '            	
                  <div class="class_row_td left">'.$invoice_details->l_row7.'</div>
            ...
            if($invoice_details->bu_row8 != ''){
            	$row8 = '            	
                  <div class="class_row_td left">'.$invoice_details->m_row8.'</div>
            ...
            if($invoice_details->bv_row9 != ''){
            	$row9 = '            	
                  <div class="class_row_td left">'.$invoice_details->n_row9.'</div>
            ...
            if($invoice_details->bw_row10 != ''){
            	$row10 = '            	
                  <div class="class_row_td left">'.$invoice_details->o_row10.'</div>
            ...
            if($invoice_details->bx_row11 != ''){
            	$row11 = '            	
                  <div class="class_row_td left">'.$invoice_details->p_row11.'</div>
            ...
            if($invoice_details->by_row12 != ''){
            	$row12 = '            	
                  <div class="class_row_td left">'.$invoice_details->q_row12.'</div>
            ...
            if($invoice_details->bz_row13 != ''){
            	$row13 = '            	
                  <div class="class_row_td left">'.$invoice_details->r_row13.'</div>
            ...
            if($invoice_details->ca_row14 != ''){
            	$row14 = '            	
                  <div class="class_row_td left">'.$invoice_details->s_row14.'</div>
            ...
            if($invoice_details->cb_row15 != ''){
            	$row15 = '            	
                  <div class="class_row_td left">'.$invoice_details->t_row15.'</div>
            ...
            if($invoice_details->cc_row16 != ''){
            	$row16 = '            	
                  <div class="class_row_td left">'.$invoice_details->u_row16.'</div>
            ...
            if($invoice_details->cd_row17 != ''){
            	$row17 = '            	
                  <div class="class_row_td left">'.$invoice_details->v_row17.'</div>
            ...
            if($invoice_details->ce_row18 != ''){
            	$row18 = '            	
                  <div class="class_row_td left">'.$invoice_details->w_row18.'</div>
            ...
            if($invoice_details->cf_row19 != ''){
            	$row19 = '            	
                  <div class="class_row_td left">'.$invoice_details->x_row19.'</div>
            ...
            if($invoice_details->cg_row20 != ''){
            	$row20 = '            	
                  <div class="class_row_td left">'.$invoice_details->y_row20.'</div>
	         ...
	         <div class="tax_table_div">
	            <div class="tax_table">
	              ...
	              <div class="tax_row">
	                ...
	                <div class="tax_row_td right">'.number_format_invoice($invoice_details->vat_value).'</div>
	              </div>
	              <div class="tax_row">
	              ...
	              <div class="tax_row">
	                ...
	                <div class="tax_row_td right" style="color:#fff">..</div>
	              </div>
	              <div class="tax_row">
	...
	public function invoice_saveas_pdf()
	{
		$html = '<style>
		    ...
		    .tax_table_div{width: 100%;}
            .tax_table{margin-left:80%;width: 20%;}
            .details_table .class_row .class_row_td { font-size: 14px; font-weight: 600;float:left; }
            .details_table .class_row .class_row_td.left{position:absolute; left:80px; width:600px; text-align: left;}
            .details_table .class_row .class_row_td.right{margin-left:605px; text-align: right; padding-right: 10px;}
            .details_table .class_row{line-height: 30px;}
            .details_table { height : 420px !important; }

            .tax_table .tax_row .tax_row_td{ font-size: 14px; font-weight: 600;float:left;}
            .tax_table .tax_row .tax_row_td.left{position:absolute; left:80px; width:600px; text-align: left;}
            .tax_table .tax_row .tax_row_td.right{{margin-left:605px;text-align: right; padding-right: 70px;border-top: 2px solid #000;}
            .tax_table .tax_row{line-height: 30px;}

            .company_details_div{width: 800px; margin-top: 220px;}
            .firstname_div{position:absolute; left:80px; right:80px; width:600px; margin-top: 25px;}
            .aib_account{ margin-left:610px; color: #ccc; font-size: 12px; }

            .account_details_div{width: 800px;}
            .account_details_address_div{position:absolute; left:80px; width:560px;}
            .account_table .account_row .account_row_td.left{margin-left:570px;}
            .account_table .account_row .account_row_td.right{margin-left:650px;padding-top:-18px;}
