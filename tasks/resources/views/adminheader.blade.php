...
<?php $segment1 =  Request::segment(2); ?>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right menu">
            ...
            <li class="dropdown <?php if($segment1 == "profile" || $segment1 == "vat_profile") { echo 'active'; } ?>"><a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Profile</a>
                <ul class="dropdown-menu">
