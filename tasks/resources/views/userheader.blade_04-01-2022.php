...
<?php
 ...
 elseif($page_segment == "purchase_invoice_to_process") { $title = 'Purchase Invoices to Process'; }
              ...
              <table class="table own_table_white">
                <thead>
                  <tr>
                    ...
                    <th style="width: 150px; text-align: right;">Outstanding Value</th>
                    <th style="width: 100px;">Journal ID</th>
                    <th style="width: 120px;">Clearance Date</th>
                  </tr>
                </thead>
...
<div class="modal fade general_journal_modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" data-backdrop="static" data-keyboard="false" style="z-index: 99999999 !important; background: rgba(0,0,0,0.3) ">
  <div class="modal-dialog" role="document" style="width:70%;">
    <div class="modal-content">
      ...
      <div class="modal-footer" style="clear:both">        
        <input type="button" value="Save" name="" class="common_black_button save_general_journal_button" style="display:none">        
      </div>
      </form>
    </div>
  </div>
...
if($(e.target).hasClass('add_general')){
  ...
  $("#general_journal_tboday").append('<tr><td><select class="general_nominal" name="general_nominal[]"><option value="">Select Nominal Code</option>'+general_nominal+'</select><label class="error error-general-nominal" ></label></td><td><input type="type" class="general_journal_desription" required placeholder="Enter Journal Desription" name="general_journal_desription[]"><label class="error error-general_journal_desription" ></label></td><td><input type="text" style="text-align: right;" class="general_debit" value="0.00" required placeholder="Enter Debit Value" name="general_debit[]" oninput="keypressonlynumber(this)"><label class="error error-general_debit" ></label></td><td><input type="text" style="text-align: right;" class="general_credit" value="0.00" required placeholder="Enter Credit Value" name="general_credit[]" oninput="keypressonlynumber(this)"><label class="error error-general_credit" ></label></td><td style="text-align: center;"><a href="javascript:" class="fa fa-plus add_general" style="margin-top: 10px;display:none"></a><a href="javascript:" class="fa fa-trash delete_general" style="margin-top: 10px; " title="Delete"></a></td></tr>');
