...
.table_bg>tbody>tr>td, .table_bg>tbody>tr>th, .table_bg>tfoot>tr>td, .table_bg>tfoot>tr>th, .table_bg>thead>tr>td{color: #333 !important}
...
<div class="content_section" style="margin-top: 165px;">
      ...
      <table class="table_bg table-fixed-header own_table_white" style="width: 2000px; margin: 0px auto;margin-bottom:30px; background: #fff">
          ...
          <thead class='header'>
            ...
            <tr>
                ...
                <th width="250px" style="min-width: 320px; max-width: 550px;">P30 Task <i class="fa fa-sort task_sort_std" aria-hidden="true"></th>
          ...
          <tbody id="task_body_std">
              ...
              ?>
               ...
               ?>
                ...
                <?php if($result->task_status == 1) { $task_label='style="color:#f00;font-weight:800"'; } elseif($result->na == 1) { $task_label='style="color:#da8e04;font-weight:800"'; }  else{ $task_label='style="font-weight:600"'; } ?>
