    ...
    <div class="select_button">
        <table class="table table_bg">
          ...
          <tbody>
            ...
            <tr>
                <td style="text-align:left; border:1px solid #000"><a href="<?php echo URL::to('user/p30_select_month/'.base64_encode($month->month_id))?>" class="btn" style="text-align:left;"><?php echo $month->month.'. '.$month_name; ?> P30</a></td>
                ...
                <td style="text-align:left; margin-left:20px; border:1px solid #000"><label><?php echo $arraydate[$count]; ?></label></td>
            </tr>
            <?php 
            $count = $count - 1;
            } } 
