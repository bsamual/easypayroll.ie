...
<div class="content_section">
  ...
  <div class="select_button" style="margin-bottom:20px">
        <ul>
     	...
     	<p style="clear: both;font-size: 18px;font-weight: 800;color: #fff; text-shadow: 0px 1px 2px #000; position: absolute;bottom:8%;text-align: center;width: 98%;">
     	You Are In The P30 System
     	<br/>
     	<spam style="position: absolute;bottom: 66%;right: 12%;">MANAGE P30</spam>
     	<a href="<?php echo URL::to('user/p30_period'); ?>" class="common_black_button" style="float:right">Manage Period</a>
     	<a href="<?php echo URL::to('user/p30_due_date'); ?>" class="common_black_button" style="float:right">Manage Due Date</a>
