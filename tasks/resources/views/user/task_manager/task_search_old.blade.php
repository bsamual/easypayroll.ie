      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <a href="javascript:" class="common_black_button" id="create_new_task" style="float:right;">New task</a>
		    	<div class="compressed_layout_div" style="float:right;width:31%;">
    ...
    <div class="table-responsive" style="width: 100%; float: left;margin-top:250px;min-height:500px ">
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane active in" id="home" role="tabpanel" aria-labelledby="home-tab">
          ...
          <div style="position:fixed;background: #fff;width: 100%;height: 103px;padding-top: 21px; z-index:9px; top: 275px; ">
            <div class="col-md-2">
          ...
          <div class="open_layout_div" style="margin-top:30px">
	          		...
	          		<tr class="hidden_tasks_th" id="menulist">
	                    <td style="background: #fff;padding:0px;border-bottom:3px solid #000;border-right: 0px solid">
	                    	<table style="width:100%">
		                    	<tr>
		                    		<td style="color:#000;width:45%;padding:10px; font-size:14px; font-weight:600;">Client/Task Name<i class="fa fa-sort taskname_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></td>
    ...
    alert("You are not authorized to edit this task. You should be either an author or the allocated user to edit this task");
		...
		if($(e.target).parents(".hidden_tasks_tr").length > 0)
		{
		    ...
		    if(layout == "1")
			{
			  ...
			  $(".open_layout_div").css("margin-top","31px");
			  ...
			  if(open_tasks_height < 50)
			  {
			    $(".table_layout").css("margin-top","20px");
			      ...
			      $(".table_layout").css("margin-top","220px");
			    }
			}
			else{
  	    ...
  	    if($(e.target).parents(".switch").length > 0)
		{
            ...
            if(layout == "1")
			{
			  ...
			  $(".table_layout").find(".hidden_tasks_tr:first").find("td").css("background","#2fd9ff");
			}
			else{
			  $(".tasks_tr").show();
			  $(".tasks_tr").next().show();
