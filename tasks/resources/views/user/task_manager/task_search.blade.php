    ...
    <div class="table-responsive" style="width: 100%; float: left;margin-top:160px;min-height:500px ">
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane active in" id="home" role="tabpanel" aria-labelledby="home-tab">
          ...
          <div style="margin-top:-6px;position:fixed;background: #fff;width: 100%;height: 103px;padding-top: 21px;">
            <div class="col-md-2">
            ...
            <div class="col-md-2 open_task_div" style="padding:0px">
              ...
              <input type="radio" name="open_task_search" class="open_task_search" id="open_task_search_1" value="1" checked><label for="open_task_search_1">Open Tasks</label>
          ...
          <div class="open_layout_div" style="margin-top:53px">
    ...
    alert("You are not authorized to edit this task. You should be either an author or the allocated user to edit this task");
		...
		if($(e.target).parents(".hidden_tasks_tr").length > 0)
		{
		    ...
		    if(layout == "1")
			{
			  ...
			  $(".open_layout_div").css("margin-top","44px");
			  ...
			  if(open_tasks_height < 50)
			  {
			    $(".table_layout").css("margin-top","20px");
			      ...
			      $(".table_layout").css("margin-top","380px");
			    }
			}
			else{
