...
if(Session::has('taskmanager_user'))
{
  ...
  $check_db = DB::table('user')->where('user_id',$userid)->first();
...
<div class="content_section">
	<div id="fixed-header" style="width:100%;position: fixed;background: #fff;">
      ...
      <h4 class="col-lg-12 padding_00 new_main_title">Task Manager</h4>
        ...
        <div class="col-lg-2 padding_00">
          <label class="col-lg-2" style="text-align: right;  line-height: 35px;">View:</label>
          <div class="col-lg-10">
          ...
          <a href="javascript:" class="common_black_button" id="create_new_task" style="float:right;">New task</a>
            ...
            <label style="float: right; margin-right: 10px;" >Compressed Layout:</label>
          </div>
		    </div>
              ...
              <tr>
                <td colspan="4" style="background: #fff;border: 0px">
          		...
          		<tr class="hidden_tasks_th" id="menulist">
                    <td style="background: #fff;padding:0px;border:1px solid #868686;border-right: 0px solid">
                    	<table style="width:100%">
	                    	<tr>
	                    		<td style="color:#000;width:5%;padding:10px; font-size:15px; font-weight:600;border-right: 1px solid #868686"><i class="fa fa-sort redlight_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></td>
	                    		<td style="color:#000;width:45%;padding:10px; font-size:15px; font-weight:600;border-right: 1px solid #868686">Client/Task Name<i class="fa fa-sort taskname_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></td>
                          <td style="color:#000;width:5%;padding:10px; font-size:15px; font-weight:600;border-right: 1px solid #868686"></td>
                    ...
                    <td style="background: #fff;padding:0px;border:1px solid #868686;border-right: 0px solid">
                    	<table style="width:100%">
	                    	<tr>
	                    		<td style="color:#000;width:50%;padding:10px; font-size:15px; font-weight:600;border-right: 1px solid #868686">Author Name<i class="fa fa-sort author_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></td>
                    ...
                    <td style="background: #fff;padding:0px;border:1px solid #868686;border-right: 0px solid">
                    	<table style="width:100%">
	                    	<tr>
	                    		<td style="color:#000;width:50%;padding:10px; font-size:15px; font-weight:600;border-right: 1px solid #868686">Due Date<i class="fa fa-sort duedate_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></td>
                    ...
                    <td style="background: #fff;padding:0px;border:1px solid #868686">
                    	<table style="width:100%">
	                    	<tr>
	                    		<td style="color:#000;width:40%;padding:10px; font-size:15px; font-weight:600;border-right: 1px solid #868686">Task ID<i class="fa fa-sort taskid_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></td>
	                    		<td style="color:#000;width:40%;padding:10px; font-size:15px; font-weight:600;border-right: 1px solid #868686">Progress<i class="fa fa-sort progress_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></td>
