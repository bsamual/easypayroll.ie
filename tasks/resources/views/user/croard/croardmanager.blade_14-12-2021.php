                ...
                $rbo_submission = '';
                  ...
                  $croname_company = preg_replace('/[[:^print:]]/', '', strtolower($cro_ard_details->company_name));
                    ...
                    $cmname = ($client->company == "")?$client->firstname.' & '.$client->surname:$client->company;
	              		$cmp = '<spam class="company_td company_blue" data-crono="'.$client->client_id.'" data-cmname="'.$cmname.'" data-croname="'.$cro_ard_details->company_name.'" style="color:blue;font-style:italic;font-weight:800">'.$cro_ard_details->company_name.'</spam>';
	              	}
    ...
    if(yellow_status > 0)
    {
      ...
      if(blue_status > 0)
      {
        ...
        $(".company_blue").each(function() {
          ...
          html_output+='<tr><td>'+company_number+'</td><td>'+cm_name+'</td><td>'+cro_name+'</td></tr>';
        })
