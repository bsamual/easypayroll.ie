            ...
            <div class="col-lg-3 text-right"  style="padding: 0px;" >
              <div class="select_button" style=" margin-left: 10px;">
                ...
                <div class="report_div" style="display: none">
                    ...
                    <input type="radio" name="report_invoice" id="allinvoice" class="class_invoice" value="1"><label for="allinvoice">All Invoice</label>
...
<table class="display nowrap fullviewtablelist" id="client_expand" width="100%">
                        ...
                        <?php
                          ...
                          ?>
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td align="left" style="<?php echo $textcolor?>"><?php echo $invoice->invoice_number; ?></td>
                                <td align="left" style="<?php echo $textcolor?>"><?php echo date('d-M-Y',strtotime($invoice->invoice_date)); ?></td>
                                ...
                                <td align="left" style="<?php echo $textcolor?>"><?php echo number_format((float)$invoice->inv_net, 2, '.', ''); ?></td>
                                <td align="left" style="<?php echo $textcolor?>"><?php echo $invoice->vat_rate; ?> %</td>
                                <td align="left" style="<?php echo $textcolor?>"><?php echo number_format((float)$invoice->gross, 2, '.', ''); ?></td>
                            ...
                            if($i == 1)
                            {
                              ...
                              if(count($invoicelist) == 1000)
                              {
                                echo '<tr class="trtable loadmore_tr" style="height:0px !important;">
                                  <td style="text-align:center; padding:0px;"></td>
                                  <td style="text-align:center; padding:0px;"></td>
                                  <td style="text-align:center; padding:0px;"></td>
                                  <td style="text-align:center; padding:0px;"></td>
                                  <td style="text-align:center; padding:0px;"><div class="load_more"></div></td>
                                  <td style="text-align:center; padding:0px;"></td>
                                  <td style="text-align:center; padding:0px;"></td>
                                  <td style="text-align:center; padding:0px;"></td>
                                  <td style="text-align:center; padding:0px;"></td>                                  
...
<div id="report_pdf_type_two" style="display:none">
  ...
  <h3 id="pdf_title_all_ivoice" style="width: 100%; text-align: center; margin: 15px 0px; float: left;">Report of All Invoices</h3>
