...
<div class="content_section" style="margin-bottom:200px">
  <div class="page_title">
      <div class="col-lg-5"  style="padding: 0px;">
          <a href="javascript:" class="common_black_button invoice_nominals" style="font-size: 13px; font-weight: 500;">Invoice Nominals</a><br/>
          <a href="javascript:" style="line-height:52px;font-size: 13px; font-weight: 500;" class="common_black_button invoice_import">Import</a>
          <a href="javascript:" class="common_black_button reportclassdiv" style="font-size: 13px; font-weight: 500;">Report</a>
          ...
          <div class="col-lg-8" style="padding-right: 0px;position: absolute;top:-10px;left:18%">
            <div class="col-md-12">
      ...
      <h4 class="col-lg-2" style="padding: 0px;text-align:center">
            Invoice Management                
      </h4>
      <div class="col-lg-5"  style="padding: 0px;margin-top:-5px">
        ...
        <div class="col-md-5 col-md-offset-7" style="margin-top:5px">
      ...
      <table class="display fullviewtablelist" id="client_expand" width="100%">
          <thead>
          <tr style="background: #fff;">
              ...
              <th style="text-align: left;">Client ID</th>
              <th style="text-align: left;width:27%">Company Name</th>
              <th style="text-align: right;">Net</th>
              <th style="text-align: right;">VAT</th>
              <th style="text-align: right;">Gross</th>
              <th style="text-align: left;">Statement</th>
              <th style="text-align: left;">Journal ID</th>
          </tr>
          </thead>                            
...
function next_invoice_check(count)
{
  ...
  $.ajax({
    ...
    success:function(result)
    {
      $(".invoice_class:eq("+count+")").parents("tr").find(".jids").html(result);
      setTimeout( function() {
...
$(window).click(function(e) {
  ...
  {
    var len = $(".invoice_class").length;
    if(len == 0)
    {
      alert("Please list the invoices and then proceed with 'Invoice Nominals' button to create the journals.");
    }
    else{
      ...
      $.ajax({
        ...
        success:function(result)
        {
          $(".invoice_class:eq(0)").parents("tr").find(".jids").html(result);
          setTimeout( function() {
