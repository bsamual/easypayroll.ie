...
<div class="content_section" style="margin-bottom:200px">
  <div class="page_title">
      <div class="col-lg-12" style="padding: 0px;text-align:center;font-size:20px;margin-top: 7px;">
  ...
  <div class="page_title" style="margin-bottom: 10px;margin-top: 25px;">
      ...
      <div class="col-lg-8" style="padding: 0px;text-align:center;font-size:20px;margin-top:1%">
          <?php
