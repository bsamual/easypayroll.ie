...
$(window).click(function(e) {
  ...
  if($(e.target).hasClass('ps_data'))
  {
	...
	{
    $(e.target).parents(".show_iframe").slideRow("up",2000);
    ...
    $('html, body').animate({
       scrollTop: ($(e.target).parents(".show_iframe").nextAll(".show_iframe:first").offset().top - 100)
     }, 2000);
	}
    ...
    $('html, body').animate({
       scrollTop: ($(e.target).parents(".show_iframe").prevAll(".show_iframe:first").offset().top - 100)
     }, 2000);
	}
  if($(e.target).hasClass('show_iframe_hide'))
  {
    $(".show_iframe").slideRow("up",2000);
  }
      ...
      if(exttype == "pdf")
      {
        ...
        $.ajax({
          ...
          success:function(result)
          {
            ...
            $(".show_iframe_"+fileid).slideRow('down', 2000);
            setTimeout(function() {
              $('body').removeClass('loading');
            },2000);
          }
