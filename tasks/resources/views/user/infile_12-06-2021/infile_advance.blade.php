...
elseif($search_type == "all")
{
  ...
  $details = DB::table('cm_clients')->where('client_id',$client_id)->first();
  if($details->company != "")
  {
...
<div class="content_section" style="margin-bottom:200px">
  <div class="page_title">
      <div class="col-lg-12" style="padding: 0px;text-align:center;font-size:20px;margin-top: -10px;">
        InFiles: Client Supplied Soft File Management System
      </div>
  </div>
  <div class="page_title" style="margin-bottom: 10px;margin-top: 25px;">
      <div class="col-lg-4 text-right"  style="padding: 0px;" >
        <div class="select_button" style=" margin-left: 10px;">
          <div style="float:left;margin-top: -9px;width:50%">
            <h5 style="text-align:left;font-weight:600;margin-bottom:10px">Search Client ID: </h5>
            <input type="text" class="form-control client_common_search ui-autocomplete-input" placeholder="Enter Client Name" style="font-weight: 500;margin-bottom: 13px;margin-top:2px;width:77%;float:left" value="<?php echo $company_client; ?>" autocomplete="off">
            <input type="button" class="common_black_button load_single_client" value="Load" style="float: left;width: 21%;">
            ...
            <br/>
            <input type="button" class="common_black_button load_all_clients" value="Load All Clients" style="float: left;width:100%;margin-left: -1px;margin-top: -8px;">
          </div>
          <ul style="float: left;margin-left:25px;position:absolute;left:50%;width:60%">
            <?php 
              $user = DB::table('user_login')->where('id',1)->first();
            ?>
              <li style="width:100%;text-align:left"><input type="checkbox" name="hide_inactive" class="hide_inactive" id="hide_inactive" value="1"><label for="hide_inactive" title="Hides the Inactive Clients">Hide Inactive</label></li>
              
              <li style="width:100%;text-align:left"><input type="checkbox" name="show_incomplete" class="show_incomplete" id="show_incomplete" value="1"><label for="show_incomplete" title="Show client who have an Incomplete Batches">Show Incomplete Only</label></li>
              <!-- <li><a href="<?php echo URL::to('user/in_file'); ?>" style="font-size: 13px; font-weight: 500;">Basic View</a></li> -->
              <li><a href="javascript:" class="integrity_check_for_all" style="font-weight: 800;margin-top:-1px">Integrity Check For All Clients</a></li>
          </ul>
          
        </div>                      
      </div>
      <div class="col-lg-4" style="padding: 0px;text-align:center;font-size:20px;margin-top:1%">
        &nbsp;
      </div>
      <div class="col-lg-4">
        &nbsp;
  ...
  <div style="clear: both;">
   <?php
    if(Session::has('message')) { ?>
        <spam class="alert alert-info" style="clear: both;float: left;margin-top: 16px;"><?php echo Session::get('message'); ?> &nbsp; &nbsp;
...
<!--*************************************************************************-->
<div style="width:100%;padding:0px 2%;margin-top: 20px;">
  <table class="table table-fixed-header" id="infile_expand">
    <thead>
      <tr>
