  ...
  <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" style="height: 400px; overflow-y: scroll;">
          ...
          <div class="col-lg-2 select_all" style="padding: 0px;"><input type="checkbox" class="select_all_class" id="select_all_class" value="1" style="padding-top: 20px;"><label for="select_all_class" style="font-size: 14px; font-weight: normal;">Select all</label></div>
...
"></i></span></div>
            ...
            <div class="form-group start_group">
              ...
              <div class="img_div img_div_add" style="z-index:9999999; min-height: 214px">
  ...
  <div class="page_title">
        ...
        <h4 class="col-lg-4" style="padding: 0px;">
            ...
            <div class="col-lg-4" style="padding:5px 0px 0px 0px; ">
              ...
              <div class="select_button" style=" margin-left: 10px; width: 250px;">
...
<div id="report_pdf_type_two_single" style="display:none">
  ...
  <table class="table_style">
    <thead>
      ...
      <td style="text-align: left;border:1px solid #000;">Date Added</td>
      <td style="text-align: left;border:1px solid #000;">No. of Files</td>
      <td style="text-align: left;border:1px solid #000;">Files List</td>
      </tr>
    </thead>
    <tbody id="report_pdf_type_two_tbody_single">
