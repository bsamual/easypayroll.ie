          ...
          <div class="col-lg-3" style="margin-top:-32px">
            ...
            <div class="col-lg-12 button_top_right one_by_one" style="float: left;">
                <ul style="float: left; margin-bottom: 5px;">
                  ...
                  <li style="width:47%">
                    <a href="javascript:" class="show_hide_disable" data-element="<?php if($year->disable_clients == 1) { echo 'show'; } else { echo 'hide'; } ?>" style="width:90%;"><?php if($year->disable_clients == 1) { echo 'Show Disabled Clients'; } else { echo 'Hide Disabled Clients'; } ?></a>
                  ...
                  <li style="width:100%">
                    <a href="javascript:" class="quick_access_ros" style="width:90%;">Quick Access ROS Liabilities</a>
