                        ...
                        foreach ($joblist_child as $child) {
                          ...
                          <tr>
                            ...
                            if($child->stop_time != "00:00:00")
                            {
                              ...
                              $output.='<span id="job_time_refresh_'.$child->id.'" style="'.$redcolor.'">'.$childnegative.' '.$jobtime.'</span> &nbsp;&nbsp;<a href="javascript:"><i class="fa fa-refresh job_time_refresh" aria-hidden="true" data-element="'.$child->id.'"></i></a>';
                            }
                            $output.='</td>
                            <td align="center" style="'.$redcolor.'">'.$buttons.'</td>
                          </tr>';
