        ...
        <table class="table" id="client_expand" width="100%" style="margin-top: 10px;">
            <thead>
              <tr style="background: #fff;">
                  ...
                  <th width="8%" style="text-align: left;">Amount <i class="fa fa-sort amount_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
                  <th width="8%" style="text-align: left;">Journal ID <i class="fa fa-sort journal_sort" aria-hidden="true" style="float: right;margin-top: 4px;"></i></th>
