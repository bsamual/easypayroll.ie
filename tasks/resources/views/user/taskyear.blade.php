          ...
          <tr class="sno_tr">            
            ...
            <td align="center">
                ...
                if($task->taskyear_status ==0){
                  echo'<a href="'.URL::to('user/deactive_taskyear',base64_encode($task->taskyear_id)).'"><i style="color:#00b348;" class="fa fa-check" aria-hidden="true"></i></a>';
                }
                else{
                  echo'<a href="'.URL::to('user/active_taskyear',base64_encode($task->taskyear_id)).'"><i style="color:#f00;" class="fa fa-times" aria-hidden="true"></i></a>';
                }
                ?>
