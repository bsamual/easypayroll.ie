...
Dropzone.options.imageUpload = {
    ...
    init: function() {
        ...
        this.on("success", function(file, response) {
            ...
            $(".tasks_tr_"+obj.client_id).find("#add_files_vat_client_"+obj.month_year).find(".attachment_div").append("<p><a href='javascript:' data-element='"+obj.download_url+"' class='file_attachments' title='"+obj.filename+"' download><img src='<?php echo URL::to('assets/images/pdf.png'); ?>' style='width:30px !important'></a> <a href='"+obj.delete_url+"' class='fa fa-trash delete_attachments'></a></p>");
