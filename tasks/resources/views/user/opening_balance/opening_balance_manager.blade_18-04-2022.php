        ...
        <table class="display nowrap fullviewtablelist own_table_white" id="client_expand" width="100%">
          <thead>
            <tr style="background: #fff;">
                ...
                <th style="text-align: left;width:10%">OS invoices at OB Date <a href="javascript:" class="fa fa-refresh refresh_os_invoice" style="margin-left:20px;font-size: 20px;font-weight: 800;" title="Refresh OS invoices at OB Date"></a></th>
                ...
                if(count($clientlist)){              
                  foreach($clientlist as $key => $client){
                      ...
                      <tr class="edit_task <?php echo $active_cli; ?> <?php echo $disabled; ?>" style="<?php echo $style; ?>"  id="clientidtr_<?php echo $client->id; ?>">
                        ...
                        <td align="left" class="os_td"></td>
                        <td align="left" class="bal_td">
                          <?php echo $balance; ?>
                        </td>
...
$(window).dblclick(function(e){
  if($(e.target).hasClass('os_td_spam')){
    ...
    $.ajax({
      ...
      success:function(result){
        if(result == 1){
          $.colorbox({html:'<p style="text-align:center;margin-top:10px;font-size:18px;font-weight:600;color:#000">Client is locked since you cant able to set a Balance.</p>',fixed:true,width:"800px"});
        }
        else{
          if(parseFloat(value) > 0){
            ...
            $(e.target).parents("tr").find(".bal_td").html("0.00");
