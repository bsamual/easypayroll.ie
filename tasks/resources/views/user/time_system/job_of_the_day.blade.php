        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group client_group">                
                <input  type="text" class="form-control client_search_class" name="client_name" placeholder="Enter Client Name / Client ID">
        ...
        <h4 class="col-lg-3" style="padding: 0px;">
            ...
            <div class="col-lg-3 text-right" style="padding-right: 0px; line-height: 35px;">
              <form action="post">
                ...
                <div class="col-lg-4">
                    <input type="button" class="ok_button search_button" value="Search"  name="">
            ...
            <div class="col-lg-3 text-right" style="padding: 0px;float:right">
              <div class="select_button" style=" margin-left: 10px;">
                <ul>
                <li><a href="javascript:" style="font-size: 13px; font-weight: 500; opacity: 0.5" class="class_report_csv">Report CSV</a></li>               
                <li><a href="javascript:" style="font-size: 13px; font-weight: 500; opacity: 0.5" class="class_report_pdf">Report PDF</a></li> 
...
<div class="row">
  <div class="col-lg-12">
     <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a href="<?php echo URL::to('user/time_me_all_job')?>">All Jobs </a></li>
...
<h3 id="pdf_title_all_ivoice" style="width: 100%; text-align: center; margin: 15px 0px; float: left;">Jobs of the Day &#8211; <?php echo date('m/d/y')?></h3>

  <table class="table_style">
    <thead>
      <tr style="background: #fff;">        
        <th width="2%" style="text-align: left; border-bottom:1px solid #ccc; border-right:1px solid #ccc; padding-left:5px">S.No00</th>
    ...
    if($(".select_job:checked").length)
      {
        ...
        $.ajax({
          ...
          success: function(result)
          {
            SaveToDisk("<?php echo URL::to('job_file'); ?>/joboftheday_Report.csv",'joboftheday_Report.csv');
          }
        });
      }
...
$(document).ready(function() {    
  $(".client_search_class").autocomplete({
    ...
    ?>
      ...
      var dateval = "<?php echo date('F d, Y'); ?>";
