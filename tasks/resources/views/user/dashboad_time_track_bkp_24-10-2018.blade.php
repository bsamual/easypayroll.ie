          ...
          <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class='input-group date'>                    
                        <input class="form-control dateclass" name="date" value="" readonly>
                    </div>
                  </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class='input-group date'>
                        <input type='text' class="form-control stop_start_time" readonly placeholder="Select Stop Time" name="stoptime" style="font-weight: 500;" required />
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-time"></span>
                        </span>
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class='input-group date stop_jom_time'>
                        <input type='text' class="form-control" id="calculate_job_time" name="stoptime" style="font-weight: 500;background-color: #eceaea !important" disabled/>
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-time"></span>
                        </span>
                    </div>
        ...
        <table class="display nowrap fullviewtablelist" id="active_job" width="100%">
          ...
          <tbody id="tbody_active">
            ...
            <tr>
              ...
              <td align="left" style="'.$redcolor.'">'.$data['start_time'] = date('h:i A', strtotime($jobs->start_time)).'</td>
              ...
              <td align="center" style="'.$redcolor.'"><a style="'.$redcolor.'" href="javascript:" class="stop_class" data-element="'.$jobs->id.'" style="'.$redcolor.'">Stop</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a style="'.$redcolor.'" href="javascript:" class="create_new_quick" data-element="'.$jobs->id.'">Create a Quick Break</a></td>
            </tr>';
              $i++;
                  }
                }
...
$(window).click(function(e) {
  ...
  {
    alert("Active Job is already created for this user for today .");
  }
  else{
  ...
  if($(e.target).hasClass('add_minutes'))
  {
    ...
    $.ajax({
      ...
      type:"get",
      dataType:"json",
      data:{element:element,break_time:break_time,jobtime:jobtime},
      success: function(result)
      {
        if(result['alert'] == 1)
        {
          alert("Break Time is exceeds the job time. Please make sure you have choosed the correct break time");
        }
        else{
