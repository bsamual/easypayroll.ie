...
if(isset($_GET['client_id']))
{
  ...
  if(count($joblist)){
    ...
    <tr>
      ...
      <th class="sorting_disabled"></td>
      <th class="sorting_disabled" style="text-align:right;">'.$sub_hour_calculate_unallocated.':'.$sub_minutes_calculate_unallocated.':00</td>
    ...
    if(count($invoice_list)){
      foreach ($invoice_list as $key => $invoice) {   
        ...
        if(!in_array($invoice->invoice_number, $explode_excluded)){
          ...
          $result_invoice.='<tr>
            ...
            <td style="text-align:right;'.$color.'">'.number_format_invoice_without_decimal($profit_percentage).' %</td>
      ...
      $result_invoice.='
          <tr>                  
            ...
            <th style="text-align:right" class="sorting_disabled">'.number_format_invoice_without_decimal($result_final_percentage).' %</th>
            <th style="text-align:right" class="sorting_disabled"></th>
          </tr>';
      $result_summary='
        <tr>                  
