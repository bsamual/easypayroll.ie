...
<?php } ?>
  ...
  <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active" href="<?php echo URL::to('user/vat_clients'); ?>">VAT Clients Imported in to VAT Management System</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="<?php echo URL::to('user/vat_review'); ?>">VAT Management System VAT Review</a>
    </li>
  </ul>
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding:0px;margin-top: 16px;">
    <div class="select_button">
      ...
      <div style="float: left;margin-left: 16px;margin-top: -10px;">
        ...
        ?>
        <spam style="color:#f00;"><?php echo $red; ?> Clients Disabled</spam><br/>
        <spam style="color:green"><?php echo $green; ?> Clients With Primary Email Address</spam>
      </div>
      <div style="float: left;margin-left: 16px;margin-top: -10px;">
        <spam style="color:#bd510a"><?php echo $yellow; ?> Clients Without Primary Email Address</spam><br/>
