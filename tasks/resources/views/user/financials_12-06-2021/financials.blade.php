    ...
    <div class="modal-content">
      <div class="modal-header" style="padding-bottom: 0px;border-bottom:0px">
        ...
        <h4 class="modal-title" id="myModalLabel">
         ...
         <table class="table" style="margin-bottom: 0px;margin-top:23px">
            <thead>
              <tr>
              ...
              if(count($clients))
              {
                foreach($clients as $client)
                {
                  ...
                  echo '<tr class="client_tr_'.$client->client_id.'">
                      ...
                      <td style="width:9%">
                        <input type="text" class="form-control balance_fin_sort_val balance_fin_sort_val_'.$client->client_id.'" id="balance_fin_sort_val" value="'.number_format_invoice($balance).'" style="'.$bal_style.'" disabled>
                        '.$owed_text.'
                      </td>
...
<div class="content_section" style="margin-bottom:200px">
    <div class="page_title">
        <h4 style="text-align: center;font-weight:600;font-size:20px">Financials</h4>
        <div class="col-md-6">
