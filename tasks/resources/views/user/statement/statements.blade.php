...
<div class="content_section" style="margin-bottom:200px">
  <div style="width: 98%; float: left; position: fixed;" id="headerfixed">
    ...
    <div class="row" style="margin-top:25px;">
      <div class="col-md-12" id="load_table_clients" style="margin-top: 119px; padding: 0px;">
      </div>
      <a href="javascript:" class="fa fa-cog common_black_button statement_settings" style="float:right;margin-right:1%; position: fixed; bottom:90px; right: 20px;opacity: 1;"> Settings</a>
    </div>
</div>
