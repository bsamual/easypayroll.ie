    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="clear:both">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Journals</a>
          </li>
        </ul>
        <div class="tab-content" id="myTabContent" style="margin-top: 20px;">
          ...
          <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <input type="button" name="submit_rounding" class="common_black_button submit_rounding" value="Submit" style="margin-top:10px">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="clear:both">
        <div class="row">
          <div class="col-lg-9">
            <div class="row">
              ...
              <div class="col-lg-4">
                ...
                <label for="report_details">Details Purchase Analysis</label>
              </div>
              <div class="col-lg-4">
                <input type="radio" value="3" id="report_ledger" class="report_radio" name="report_radio">
                <label for="report_ledger">Purchase Ledger Report</label>
              </div>
          ...
          <div class="col-lg-3">
              <a href="javascript:" class="common_black_button run_report_invoice" style="width: 100%; font-size: 17px !important; float: left; padding: 14px;">Run<br/>Report</a>
          </div>
        </div>
