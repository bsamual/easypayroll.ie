...
<div class="content_section" style="margin-bottom:200px">
  	<div class="page_title">
        ...
        <div class="col-md-12" style="padding:0px;width:125%">
        <div class="col-md-4" style="width:25%;min-height:1500px;border-right:1px solid #dfdfdf">
        	<h3>Invoice List</h3>
    ...
    init: function() {
        ...
        this.on("success", function(file, response) {
            ...
            if(obj.type == "1"){
              ...
              $("#current_tax_tbody").html(obj.output);
            }
            else{
