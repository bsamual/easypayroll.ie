...
class TimejobController extends Controller {
	...
	*/
	...
	public function timejobadd(){
		...
		$jobdetails = DB::table('task_job')->where('user_id', Input::get("user_id"))->where('job_date', $dateverify)->where('status',0)->first();
	...
	public function jobuserfilter(){
      ...
      echo json_encode(array('activejob' => $output, 'closejob' => $outputclose,'username' => $username,'spendminutes' => $spendminutes,'spendhours' => $spendhours));
