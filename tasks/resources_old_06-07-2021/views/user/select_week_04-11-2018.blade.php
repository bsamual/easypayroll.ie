      ...
      <div class="modal-body">
          ...
          <div class="select_button" style="min-height:48px;float:none">
            ...
            <ul>
                ...
                $current_year = DB::table('year')->orderBy('year_name', 'desc')->first();
      ...
      <div class="modal-body">
          ...
          <div class="row" style="margin-top:10px">
            ...
            <div class="col-md-10">
                ...
                <label style="margin-top:40px" id="task_report_label">Task_Report_For_Year-<?php echo $yearname->year_name; ?>_Week-<?php echo $weekid->week; ?>.pdf</label>



                <label style="margin-top:40px" id="notify_report_label">Notify_Report_For_Year-<?php echo $yearname->year_name; ?>_Week-<?php echo $weekid->week; ?>.pdf</label>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="col-md-3">
                ...
                <input type="checkbox" class="notify_id_class" name="username" id="user_<?php echo $user->user_id?>" data-element="<?php echo $user->email; ?>" data-value="<?php echo $user->user_id; ?>"><label for="user_<?php echo $user->user_id?>"><?php echo $user->firstname?></label>
...
<div class="content_section" style="margin-bottom:200px">
  ...
  ?>
    ...
    <div class="col-lg-4 padding_00" style="margin-left: 1%;">Task of <?php echo $yearname->year_name ?> &nbsp;&nbsp;&nbsp;&nbsp; Week : Week <?php echo $weekid->week ?> &nbsp;&nbsp;&nbsp;&nbsp; No of days : <?php echo $days; ?></div>
...
?>
      ...
      <table class="table_bg table-fixed-header" style="width: 2000px; margin: 0px auto;">
          ...
          <tbody id="task_body_std">
              ...
              <?php if($result->task_status == 1) { $task_label='style="color:#f00;font-weight:800"'; } elseif($result->task_complete_period == 1) { $task_label='style="color:#1b0fd4;font-weight:800"'; } elseif($result->task_started == 1) { $task_label='style="color:#89ff00;font-weight:800"'; } else{ $task_label='style="color:#fff;font-weight:600"'; } ?>
                  ...
                  <td align="center" class="special_td" style="width:90px;float:left">
                    ...
                    <div class="special_div" style="text-align: left;border-top:1px solid #000;width:680%;margin-top:20px;clear:both;float:left">
                      ...
                      ?>
                        ...
                        ?>
                            ...
                            <?php if(count($attachments)) { ?>
                                ...
                                <i class="fa fa-minus-square fadeleteall_attachments <?php echo $disabled; ?>" data-element="<?php echo $result->task_id; ?>" style="margin-top:10px" aria-hidden="true" title="Delete All Attachments"></i>
                        ...
                        <?php
                            ...
                            if(count($commonuser)){
                              ...
                              foreach ($commonuser as $singleuser) {
                                ...
                                if($result->users == $singleuser) { $selected = 'selected'; } else{ $selected = ''; }



                                $usertext = DB::table('user')->where('user_id', $singleuser)->first();
    ...
    $uname = '<option value="'.$usertext->user_id.'" '.$selected.'>'.$usertext->firstname.' '.$usertext->lastname.'</option>';
    ...
    $uname = $uname.'<option value="'.$usertext->user_id.'" '.$selected.'>'.$usertext->firstname.' '.$usertext->lastname.'</option>';
                  ...
                  <td align="center" style="text-align: left">
                      ...
                      ?>
                          ...
                          <?php if(count($attachments)) { ?>
                              ...
                              <i class="fa fa-minus-square fadeleteall <?php echo $disabled; ?>" data-element="<?php echo $result->task_id; ?>" style="margin-top:10px" aria-hidden="true" title="Delete All Attachments"></i>
    ...
    $.each( emails, function( i, value ) {
        ...
        setTimeout(function(){
          ...
          $.ajax({
            ...
            data:{email:value,message:message,toemails:toemails},
