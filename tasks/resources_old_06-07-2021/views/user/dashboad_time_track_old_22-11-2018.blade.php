        ...
        <table class="display nowrap fullviewtablelist" id="active_job" width="100%">
          ...
          <tbody id="tbody_active">
            ...
            <tr>
              ...
              <td align="center" style="'.$redcolor.'"><a style="'.$redcolor.'" href="javascript:" class="stop_class" data-element="'.$jobs->id.'" style="'.$redcolor.'">Stop</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a style="'.$redcolor.'" href="javascript:" class="create_new_quick" data-element="'.$jobs->id.'">Quick Job</a></td>
