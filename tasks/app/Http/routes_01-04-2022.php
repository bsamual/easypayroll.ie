...
Route::get('client-invoice-management', 'user\UserauthenticateController@client_invoice_management');
Route::get('the-2-bill-manager', 'user\UserauthenticateController@the_2_bill_manager');
Route::get('practice-financials', 'user\UserauthenticateController@practice_financials');
Route::get('the-payroll-management-system', 'user\UserauthenticateController@the_payroll_management_system');
Route::get('the-payroll-modern-reporting-system', 'user\UserauthenticateController@the_payroll_modern_reporting_system');
Route::get('the-year-end-manager', 'user\UserauthenticateController@the_year_end_manager');
Route::get('the-client-request-system', 'user\UserauthenticateController@the_client_request_system');
Route::get('the-vat-management-system', 'user\UserauthenticateController@the_vat_management_system');
Route::get('the-rct-System', 'user\UserauthenticateController@the_rct_System');
Route::get('the-cro-ard-system', 'user\UserauthenticateController@the_cro_ard_system');
Route::get('time-management-tools', 'user\UserauthenticateController@time_management_tools');
Route::get('the-infiles-system', 'user\UserauthenticateController@the_infiles_system');
...
Route::get('bubble-accounting', 'user\UserauthenticateController@bubble_accounting');
...
Route::get('/admin/table_viewer', 'admin\AdminController@table_viewer');
Route::post('/admin/show_table_viewer', 'admin\AdminController@show_table_viewer');
Route::post('/admin/show_table_viewer_append', 'admin\AdminController@show_table_viewer_append');
...
Route::get('/admin/clear_receipt_system', 'admin\AdminController@clear_receipt_system');

Route::get('/admin/clear_payment_system', 'admin\AdminController@clear_payment_system');
...
Route::post('/user/getclient_salutation','user\UserController@getclient_salutation');
...
Route::get('/user/paye_p30_email_distribution/{id?}', 'user\Payep30Controller@paye_p30_email_distribution');
...
Route::get('/user/opening_balance_invoices_issued', 'user\OpeningbalanceController@opening_balance_invoices_issued');
Route::post('/user/update_outstanding_invoice', 'user\OpeningbalanceController@update_outstanding_invoice');
Route::post('/user/invoice_outstanding_upload_csv', 'user\OpeningbalanceController@invoice_outstanding_upload_csv');
Route::post('/user/check_invoice_issued_csv_file', 'user\OpeningbalanceController@check_invoice_issued_csv_file');
Route::post('/user/upload_invoice_issued_csv_file', 'user\OpeningbalanceController@upload_invoice_issued_csv_file');
...
Route::get('/user/refresh_blue_cro_ard', 'user\CroardController@refresh_blue_cro_ard');
...
Route::post('/user/update_rbo_submission', 'user\CroardController@update_rbo_submission');
...
Route::post('/user/import_client_list_timeme','user\TimemeController@import_client_list_timeme');

Route::post('/user/save_croard_settings','user\CroardController@save_croard_settings');

Route::post('/user/rbo_review_list','user\CroardController@rbo_review_list');

Route::post('/user/report_csv_rbo','user\CroardController@report_csv_rbo');

Route::get('/user/payroll_settings','user\UserController@payroll_settings');

Route::post('/user/save_payroll_settings','user\UserController@save_payroll_settings');



Route::post('/user/get_paye_email_distribution_table','user\Payep30Controller@get_paye_email_distribution_table');

Route::post('/user/send_email_to_paye_client','user\Payep30Controller@send_email_to_paye_client');



Route::post('/user/get_client_account_review_listing','user\ClientreviewController@get_client_account_review_listing');

Route::post('/user/export_client_account_review_listing','user\ClientreviewController@export_client_account_review_listing');



Route::post('/user/get_transaction_review_listing','user\ClientreviewController@get_transaction_review_listing');

Route::post('/user/export_transaction_review_listing','user\ClientreviewController@export_transaction_review_listing');



Route::post('/user/integrity_check_all_tasks','user\TaskmanagerController@integrity_check_all_tasks');

Route::post('/user/export_integrity_tasks','user\TaskmanagerController@export_integrity_tasks');





Route::get('/user/statement_list', 'user\StatementController@statement_list');

Route::post('/user/load_statement_clients', 'user\StatementController@load_statement_clients');

Route::post('/user/get_client_opening_balance', 'user\StatementController@get_client_opening_balance');

Route::post('/user/get_client_statement_values', 'user\StatementController@get_client_statement_values');



Route::post('/user/get_invoice_list_statement', 'user\StatementController@get_invoice_list_statement');

Route::post('/user/get_receipt_list_statement', 'user\StatementController@get_receipt_list_statement');



Route::post('/user/save_statement_settings', 'user\StatementController@save_statement_settings');



Route::post('/user/change_send_statement_status', 'user\CmController@change_send_statement_status');



Route::post('/user/get_author_email_for_taskmanager', 'user\TaskmanagerController@get_author_email_for_taskmanager');

Route::post('/user/check_integrity_for_task', 'user\TaskmanagerController@check_integrity_for_task');



Route::post('/user/remove_croard_refresh', 'user\CroardController@remove_croard_refresh');

Route::post('/user/remove_blue_croard_refresh', 'user\CroardController@remove_blue_croard_refresh');



Route::post('/user/summary_clients_list', 'user\FinancialController@summary_clients_list');

Route::post('/user/summary_load_opening_balance', 'user\FinancialController@summary_load_opening_balance');

Route::post('/user/summary_load_receipts', 'user\FinancialController@summary_load_receipts');

Route::post('/user/summary_load_payments', 'user\FinancialController@summary_load_payments');

Route::post('/user/summary_calculations', 'user\FinancialController@summary_calculations');

Route::post('/user/summary_export_csv', 'user\FinancialController@summary_export_csv');

Route::get('/user/client_account_review_summary', 'user\ClientreviewController@client_account_review_summary');

Route::post('/user/send_batch_email_single/', 'user\RctControllerNew@send_batch_email_single');



Route::get('/user/updatestatus_timetrack/', 'user\UserController@updatestatus_timetrack');



Route::post('/user/build_statement/', 'user\StatementController@build_statement');



Route::post('/user/edit_rctsalution/{id?}', 'user\RctControllerNew@editsalution');

Route::post('/user/update_rctsalution/', 'user\RctControllerNew@updatesalution');

Route::post('/user/update_rctletterpad/', 'user\RctControllerNew@updateletterpad');

Route::post('/user/edit_rctletterpad/{id?}', 'user\RctControllerNew@editletterpad');



Route::post('/user/load_trial_balance_nominals', 'user\FinancialController@load_trial_balance_nominals');

Route::post('/user/load_trial_balance_journals_for_nominal', 'user\FinancialController@load_trial_balance_journals_for_nominal');



Route::post('/user/update_user_notification', 'user\UserController@update_user_notification');

Route::post('/user/update_user_signature', 'user\UserController@update_user_signature');



Route::get('/user/manage_task', 'user\TaskyearController@taskyear');

Route::get('/user/manage_user', 'user\AdminuserController@manageuser');



Route::get('/user/manage_user', 'user\AdminuserController@manageuser');

Route::get('/user/deactive_user/{id?}', 'user\AdminuserController@deactiveuser');

Route::get('/user/active_user/{id?}', 'user\AdminuserController@activeuser');

Route::post('/user/add_user/', 'user\AdminuserController@adduser');

Route::get('/user/delete_user/{id?}', 'user\AdminuserController@deleteuser');

Route::post('/user/edit_user/{id?}', 'user\AdminuserController@edituser');

Route::post('/user/update_user/', 'user\AdminuserController@updateuser');



Route::post('/user/manage_user_costing', 'user\AdminuserController@manageusercosting');

Route::post('/user/user_costing_update', 'user\AdminuserController@usercostingupdate');

Route::post('/user/manage_user_cost_add', 'user\AdminuserController@manageusercostadd');

Route::post('/user/manage_user_costing_delete', 'user\AdminuserController@manageusercostingdelete');





Route::post('/user/add_taskyear/', 'user\TaskyearController@addtaskyear');

Route::get('/user/deactive_taskyear/{id?}', 'user\TaskyearController@deactivetaskyear');

Route::get('/user/active_taskyear/{id?}', 'user\TaskyearController@activetaskyear');

Route::get('/user/delete_taskyear/{id?}', 'user\TaskyearController@deletetaskyear');

Route::get('/user/edit_taskyear/{id?}', 'user\TaskyearController@edittaskyear');

Route::post('/user/update_taskyear/', 'user\TaskyearController@updatetaskyear');



Route::get('/user/task_overview', 'user\TaskmanagerController@task_overview');

Route::post('/user/load_employee_details_overview', 'user\TaskmanagerController@load_employee_details_overview');

Route::post('/user/load_client_details_overview', 'user\TaskmanagerController@load_client_details_overview');

Route::post('/user/update_practice_setting', 'user\UserController@update_practice_setting');



Route::get('/user/supplier_management', 'user\SupplierController@supplier_management');

Route::post('/user/store_supplier', 'user\SupplierController@store_supplier');

Route::post('/user/edit_supplier', 'user\SupplierController@edit_supplier');

Route::post('/user/get_supplier_transaction_list', 'user\SupplierController@get_supplier_transaction_list');



Route::get('/user/supplier_invoice_management', 'user\SupplierinvoiceController@supplier_invoice_management');

Route::get('/user/purchase_invoice_to_process', 'user\SupplierinvoiceController@purchase_invoice_to_process');



Route::post('/user/store_supplier_vat_rate', 'user\SupplierinvoiceController@store_supplier_vat_rate');

Route::post('/user/change_supplier_vat_status', 'user\SupplierinvoiceController@change_supplier_vat_status');

Route::post('/user/get_supplier_info_details', 'user\SupplierinvoiceController@get_supplier_info_details');

Route::post('/user/store_purchase_invoice', 'user\SupplierinvoiceController@store_purchase_invoice');

Route::post('/user/supplier_upload_global_files', 'user\SupplierinvoiceController@supplier_upload_global_files');

Route::post('/user/purchase_invoice_files', 'user\SupplierinvoiceController@purchase_invoice_files');

Route::post('/user/edit_purchase_invoice_supplier', 'user\SupplierinvoiceController@edit_purchase_invoice_supplier');

Route::post('/user/load_all_global_invoice', 'user\SupplierinvoiceController@load_all_global_invoice');

Route::post('/user/export_all_global_invoice', 'user\SupplierinvoiceController@export_all_global_invoice');

Route::post('/user/refresh_supplier_counts', 'user\SupplierController@refresh_supplier_counts');

Route::post('/user/export_supplier_transaction_list', 'user\SupplierinvoiceController@export_supplier_transaction_list');



Route::post('/user/delete_supplier_global_attachment', 'user\SupplierinvoiceController@delete_supplier_global_attachment');



Route::post('/user/load_all_clients_ta_system', 'user\TaController@load_all_clients_ta_system');

Route::post('/user/load_single_client_ta_system', 'user\TaController@load_single_client_ta_system');



Route::post('/user/load_all_clients_cm_system', 'user\CmController@load_all_clients_cm_system');

Route::post('/user/load_single_cm_system', 'user\CmController@load_single_cm_system');





Route::post('/user/add_edit_project', 'user\TaskmanagerController@add_edit_project');

Route::post('/user/project_details', 'user\TaskmanagerController@project_details');



Route::post('/user/export_suppliers_list', 'user\SupplierController@export_suppliers_list');

Route::post('/user/view_purchase_invoice_supplier', 'user\SupplierinvoiceController@view_purchase_invoice_supplier');



Route::post('/user/load_single_client_receipt_payment', 'user\ClientreviewController@load_single_client_receipt_payment');



Route::get('/user/rct_summary', 'user\RctControllerNew@rct_summary');

Route::post('/user/rct_summary_filter', 'user\RctControllerNew@rct_summary_filter');

Route::post('/user/rct_summary_result', 'user\RctControllerNew@rct_summary_result');



Route::post('/user/check_supplier_journal_repost', 'user\SupplierinvoiceController@check_supplier_journal_repost');



Route::post('/user/store_supplier_invoice', 'user\SupplierinvoiceController@store_supplier_invoice');



Route::post('/user/load_single_invoice_payment', 'user\SupplierController@load_single_invoice_payment');



Route::post('/user/change_supplier_files_ignore_file', 'user\SupplierinvoiceController@change_supplier_files_ignore_file');

Route::post('/user/change_supplier_files_inv_date', 'user\SupplierinvoiceController@change_supplier_files_inv_date');

Route::post('/user/change_supplier_files_supplier_id', 'user\SupplierinvoiceController@change_supplier_files_supplier_id');

Route::post('/user/delete_purchase_files', 'user\SupplierinvoiceController@delete_purchase_files');

Route::post('/user/get_purchase_invoice_files_details', 'user\SupplierinvoiceController@get_purchase_invoice_files_details');





Route::post('/user/finance_get_bank_details', 'user\FinancialController@finance_get_bank_details');

Route::post('/user/finance_reconcile_load', 'user\FinancialController@finance_reconcile_load');

Route::post('/user/finance_bank_single_accept', 'user\FinancialController@finance_bank_single_accept');

Route::post('/user/balance_per_bank', 'user\FinancialController@balance_per_bank');

Route::post('/user/finance_bank_refresh', 'user\FinancialController@finance_bank_refresh');

Route::post('/user/finance_bank_all_accept', 'user\FinancialController@finance_bank_all_accept');



Route::post('/user/check_bank_nominal_code', 'user\FinancialController@check_bank_nominal_code');



Route::post('/user/create_journal_reconciliation', 'user\FinancialController@create_journal_reconciliation');

Route::post('/user/generate_reconcile_pdf', 'user\FinancialController@generate_reconcile_pdf');

Route::post('/user/generate_reconcile_csv', 'user\FinancialController@generate_reconcile_csv');



Route::post('/user/supplier_invoice_report_download', 'user\SupplierinvoiceController@supplier_invoice_report_download');



Route::post('/user/save_general_journals', 'user\FinancialController@save_general_journals');

Route::post('/user/refresh_all_supplier_counts', 'user\SupplierController@refresh_all_supplier_counts');



Route::get('/user/supplier_opening_balance', 'user\SupplierController@supplier_opening_balance');

Route::post('/user/supplier_journal_create', 'user\SupplierController@supplier_journal_create');





Route::post('/user/finance_load_details_analysis', 'user\FinancialController@finance_load_details_analysis');

Route::post('/user/finance_analysis_report', 'user\FinancialController@finance_analysis_report');



Route::post('/user/save_attachments_messages', 'user\TaskmanagerController@save_attachments_messages');



Route::post('/user/payment_receipdt_delete_outstading', 'user\ReceiptController@payment_receipdt_delete_outstading');

Route::post('/user/outstanding_payment_receipt_download', 'user\ReceiptController@outstanding_payment_receipt_download');

Route::post('/user/outstanding_payment_receipt_delete', 'user\ReceiptController@outstanding_payment_receipt_delete');

Route::post('/user/run_creditors_listing', 'user\SupplierController@run_creditors_listing');

Route::post('/user/export_creditors_listing', 'user\SupplierController@export_creditors_listing');

Route::post('/user/supplier_invoice_report_preview', 'user\SupplierinvoiceController@supplier_invoice_report_preview');
Route::post('/user/vat_commit_upload_images', 'user\UserController@vat_commit_upload_images');
Route::post('/user/store_user_rating_taskmanager', 'user\TaskmanagerController@store_user_rating_taskmanager');
Route::post('/user/get_summary_infile_attachments', 'user\InfileController@get_summary_infile_attachments');
Route::get('/user/reset_vat_reviews_folder', 'user\UserController@reset_vat_reviews_folder');
Route::post('user/user_registration', 'user\UserauthenticateController@user_registration');

Route::post('user/change_file_status_to_zero', 'user\InfileController@change_file_status_to_zero');

Route::post('user/practice_load_review', 'user\FinancialController@practice_load_review');
Route::post('user/practice_load_client_review', 'user\FinancialController@practice_load_client_review');
Route::post('user/practice_load_staff_review', 'user\FinancialController@practice_load_staff_review');
Route::post('user/practice_review_export', 'user\FinancialController@practice_review_export');

Route::get('admin/table_viewer', 'admin\AdminController@table_viewer');
Route::post('admin/get_table_notes', 'admin\AdminController@get_table_notes');
Route::post('admin/update_table_notes', 'admin\AdminController@update_table_notes');
Route::post('admin/show_table_viewer', 'admin\AdminController@show_table_viewer');
