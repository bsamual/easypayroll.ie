	...
	*/
	...
	public function supplier_invoice_report_download(){
		...
		elseif($type == 2){
			...
			$columns_6 = array('Total Gross Purchases', number_format_invoice($total_net));
			fputcsv($fileopen, $columns_6);

			$columns_7 = array('Total VAT', number_format_invoice($total_vat_value));
			fputcsv($fileopen, $columns_7);

			$columns_7 = array('Total Net', number_format_invoice($total_gross));
			fputcsv($fileopen, $columns_7);
			...
			$columns_11 = array('GRAND TOTAL', $nominal_grand);
			...
			$columns_15 = array('GRAND TOTAL', $vat_grand);
