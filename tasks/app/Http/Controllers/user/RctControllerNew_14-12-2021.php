...
class RctControllerNew extends Controller {
  ...
  public function rct_summary_result(){
    ...
    $month_output='<table class="table own_table_white" style="min-width:'.$table_width.'px" ><thead><tr><th></th><th></th><th></th>';
    ...
    if(count($all_month)){
      foreach ($all_month as $single_month) {
        ...
        <th style="text-align:right; border-right:1px solid #000;">Net</th>';
        $month_output.='<th colspan="3" style="text-align:center; border-right:1px solid #000; border-left:1px solid #000;">'.date('M-Y', strtotime($single_month)).'</th>';
      }
      ...
      foreach ($clientlist as $client) {
        ...
        if(count($all_month)){
          foreach ($all_month as $single_month) {
            ...
            <td style="text-align:right; border-right:1px solid #000;">'.number_format_invoice($netsum).'</td>
            ';
          }
          $result_td.='
