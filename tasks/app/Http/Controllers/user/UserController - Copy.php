...
class UserController extends Controller {
	...
	*/
	...
	public function dashboard()
	{
		...
		return view('user/dashboad', array('title' => 'Welcome to BubbleAccounting', 'joblist' => $time_job, 'userlist' => $user, 'taskslist' => $tasks));
	}	
	...
	public function email_report_pdf(){
		...
		$output = '<style>
			    ...
			    $pdf->save('papers/Task_Report_For_Year-'.$year_id->year_name.'_Week-'.$year->week.'.pdf');
	   		 	...
	   		 	$subject = 'BubbleAccounting.ie: Task Report For Year '.$year_id->year_name.' Week'.$year->week.'';	
	...
	public function email_notify_pdf(){
		...
		$subject = 'BubbleAccounting.ie: Notification';
	...
	public function email_notify_tasks_pdf()
	{
		...
		$subject = 'BubbleAccounting.ie: Payroll Task Notification';
	...
	public function email_notify_pdf_month(){
		...
		$output = '<style>
			    ...
			    $pdf->save('papers/Notify_Report_For_Year-'.$year_id->year_name.'_Month-'.$year->month.'.pdf');
	   		 	...
	   		 	$subject = 'BubbleAccounting.ie: Notify Report For Year '.$year_id->year_name.' Month'.$year->month.'';	
	...
	public function email_report_pdf_month(){
		...
		$output = '<style>
				...
				$subject = 'BubbleAccounting.ie: Task Report For Year '.$year_id->year_name.' Month'.$year->month.'';	
	...
	public function edit_email_unsent_files()
	{
		...
		$html.='<strong>'.$result->salutation.'</strong><br/>';  
...

	      {
	      	...
	      	$subject = 'BubbleAccounting.ie: '.$result->task_name.' Payroll for WEEK '.$week_details->week.'';
	      	...
	      	$subject = 'BubbleAccounting.ie: '.$result->task_name.' Payroll for MONTH '.$month_details->month.'';
