...
class AmlController extends Controller {
	...
	*/
	...
	public function aml_system_add_bank(){		
		...
		$output = $aml_bank_count.'<a href="javascript:" class="bank_class" data-toggle="modal" data-toggle="modal" data-target=".bank_modal"><i class="fa fa-plus faplus add_bank"  data-toggle="tooltip" data-original-title="Add Bank" data-element="'.$current_client_id.'"  style="margin-left:10px;"></i></a>';
