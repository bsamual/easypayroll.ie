	...
	*/
	...
	public function invoice_saveas_pdf()
	{
		...
		<style>
            ...
            .details_table .class_row .class_row_td.left{position:absolute; width:50%; line-height:20px;  text-align: left;  font-size:14px; }
            .details_table .class_row .class_row_td.left_corner{ width:10%; line-height:20px;  text-align: right;}
            .details_table .class_row .class_row_td.right_start{ width:15%; line-height:20px;  text-align: right;}
            .details_table .class_row .class_row_td.right{line-height:20px; text-align: right; font-size:14px;}
